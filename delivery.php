      ...
      <section class="sb-blog-list sb-p-90-90">
        ...
        <div class="container">
          <div class="sb-masonry-grid">
            ...
            <a href="#" class="sb-blog-card sb-mb-30">
                <div class="sb-cover-frame sb-cover-vert sb-mb-30">
                  <img src="<?=LINK?>/assets/img/del.jpeg" alt="cover">
                </div>
                <div class="sb-blog-card">
                  <h3 class="sb-mb-10">Daxili Çatdırılma</h3>
                  <p class="sb-text sb-mb-15">Hava şəraitindən asılı olmayaraq, Filiallarımıza zəng edərək pulsuz çatdırılma ilə yeməklərimizin dadına baxın, siz də razı qalın! Nuş olsun!</p>
                  <a href="" onclick='window.open("https://tendirmendir.clopos.menu/menu");return false;'><p class="sb-text sb-mb-15"><font color="blue">Fəvvarələr Meydanı</font></p></a>
                  <a href="" onclick='window.open("https://tendirmendir2.clopos.menu/menu");return false;'><p class="sb-text sb-mb-15"><font color="blue">İçəri Şəhər</font></p></a>
                  <a href="" onclick='window.open("https://tendirmendir3.clopos.menu/menu");return false;'><p class="sb-text sb-mb-15"><font color="blue">Nəriman Nərimanov</font></p></a>
                </div>
              </a>
            </div>
            <div class="sb-grid-item sb-item-33">
            ...
            <div class="sb-grid-item sb-item-33">
              <a href="#" class="sb-blog-card sb-mb-30">
                <div class="sb-cover-frame sb-cover-vert sb-mb-30">
                  <img src="<?=LINK?>/assets/img/bolt.gif" alt="cover">
                </div>
                <div class="sb-blog-card">
